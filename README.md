...
性能改善の話になると、つい「Redisを入れるべきか」「Kafkaを使うべきか」「インデックスを追加すべきか」といった技術名から考え始めてしまうことがあります。

私自身も、最初はそう考えがちでした。
しかし、大量データを扱うバッチ処理やAPIの改善を考える中で、まず見るべきなのは技術名ではなく、「どこで時間がかかっているのか」を分けることだと感じるようになりました。
...
前回の考え方に続いて、ここからは実際の業務をイメージしやすいように、簡単な例で考えてみます。
